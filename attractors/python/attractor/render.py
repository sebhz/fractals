...
class Renderer(object):
    ...
    def getPalette(self, frequencies):
        ...
        gradient = palettes.getGradient(template['gradient_map'], len(frequencies), template['colorspace'])
        ...
        self.palette = dict()
        self.palette['background'] = tuple(reversed([round(component * ((1 << self.bpc)-1)) for component in palettes.rgb_norm(template['background'])]))
